...
//
// // make into array
// var newSource = sourceString.split('');
// var newSearch= searchString.split('');
//
// // get the index of search
// var indexSearch = newSource.indexOf(newSearch[0]);
//
// // if the search is not in source, return false
// // -1 means index does not exist
// if (indexSearch !== -1){
//   return false;
// }
//
// for (var i = indexSearch; i < newSource.length; i++){
//   for( var j = 0; newSearch.length; j++) {
//     if (newSource[i] === newSearch[j]){
//       i++;
//       j++;
//     }
//   }
...
builtins.isEqual = function(a, b) {
  if(a.length !== b.length){ //common rule
    return false;
  }
