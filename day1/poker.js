...
//     master1.push(hand1[i]);
//   }
//   for (var i = 0; i < master2.length; i++) {
//     master2.push(hand2[i]);
//   }
//   //check for pairs and shtuff
//   var pairs1 = 0;
//   for (var i = 0; i < master1.length; i += 2) {
//     for(var j = 0; j < master1.length; j += 2){
//       if (master1[i]===master1[j]) {
//         pairs1++;
//       }
//     }
//   }
//   var pairs2 = 0;
//   for (var i = 0; i < master2.length; i += 2) {
//     for(var j = 0; j < master2.length; j += 2){
//       if (master2[i]===master2[j]) {
//         pairs2++;
//       }
//     }
//   }
