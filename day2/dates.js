...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  var day1H = dateObj.getHours();
  var day2H = otherDateObj.getHours();
  var day3M = dateObj.getMinutes();
  var day4M = otherDateObj.getMinutes();
  var day5S = dateObj.getSeconds();
  var day6S = otherDateObj.getSeconds();

    if (day1H === day2H && day3M === day4M && day5S === day6S) {
      return true;
    }
    return false;
