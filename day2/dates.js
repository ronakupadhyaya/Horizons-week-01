...
// Write a function that takes a properly-formatted date
//string and returns a JS Date Object from a properly formatted date string.
...
// Write a function that takes two Date Objects as arguments and returns
//true if both dates occur on the same day of the week (both on Tuesdays, etc.), false otherwise
...
// Write a function that takes two Date Objects as arguments and returns true
//if both dates occur on the same time of day (both at 3:03 AM, etc.), false otherwise
// ex. dates.isSameTimeOfDay(new Date('2015-03-25 02:00:00'),
//new Date('2015-03-25 02:00:00')) -> true
// ex. dates.isSameTimeOfDay(new Date('2015-03-25'), new Date('2015-10-25')) -> true
// ex. dates.isSameTimeOfDay(new Date('2015-03-25T12:00:00'),
//new Date('2015-03-25T16:00:00')) -> false
// ex. dates.isSameTimeOfDay(new Date('2015-12-11 03:00:00'),
//new Date('2015-12-11T03:00:00')) -> false
//
...
// Write a function that takes a Date object as an argument and returns true
//if it specifies a date in the future or false if it is a time that has already passed
//
...
dates.isTheFuture = function(dateObj) {
  ...
  //debugger;
  var objTime = dateObj.getTime();

  //debugger;
  var diff = currentTime - objTime;
...
dates.incrementDay = function(dateObj) {
  // YOUR CODE HERE
  console.log(dateObj);
  var myDate = new Date(dateObj.getTime() + 86400000);
  return myDate;
};
