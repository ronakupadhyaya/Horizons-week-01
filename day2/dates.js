...
dates.isTheFuture = function(dateObj) {
  ...
  //we learned that subtracting dates allows you to determine where the dates are relative to each other
  //JS converts the dates into numbers and is able to evaluate them
...
dates.incrementDay = function(dateObj) {
  var newDate = dateObj.setDate(dateObj.getDate() + 1);
  var formattedDate = dates.createDate(newDate);
