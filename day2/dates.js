...
dates.isSameDayOfWeek = function(dateObj, otherDateObj) {
  return new Date(dateObj).getDay() === new Date(otherDateObj).getDay();
};
...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  return new Date(dateObj).getHours() === new Date(otherDateObj).getHours();
};
...
dates.incrementDay = function(dateObj) {
  return new Date(dateObj.setDate(new Date(dateObj).getDate() + 1))
};
