...
dates.createDate = function(dateStr) {
  var rDateObject = new Date(dateStr);
  // split argument into an array
  //console.log(rDateObject);
  return rDateObject;
};
...
dates.getUTCString = function(dateObj) {
  return dates.createDate(dateObj).toUTCString();
};
...
dates.isSameDayOfWeek = function(dateObj, otherDateObj) {
  if( dates.createDate(dateObj).getDay() === dates.createDate(otherDateObj).getDay()) {
    return true;
  }
  return false;
...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  if( dates.createDate(dateObj).getHours() === dates.createDate(otherDateObj).getHours()) {
    return true;
  }
  return false;
