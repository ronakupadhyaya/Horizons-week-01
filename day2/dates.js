...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  var hours1 = dateObj.getHours()
  var minutes1 = dateObj.getMinutes()
  var seconds1 = dateObj.getSeconds()

  var hours2 = otherDateObj.getHours()
  var minutes2  = otherDateObj.getMinutes()
  var seconds2 = otherDateObj.getSeconds()

  return hours1 === hours2 && minutes1 === minutes2 && seconds1 === seconds2;
};

// Exercise 3.C dates.isTheFuture(dateObj<Date>)
// Write afunction that takes a Date object as an argument and returns true if it specifies a date in the future or false if it is a time that has already passed
//
