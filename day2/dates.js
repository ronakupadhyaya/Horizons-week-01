...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  var arr1=dates.getUTCString(dateObj).split(' ');
  var arr2=dates.getUTCString(otherDateObj).split(' ');
  if (arr1.length===4 || arr2.length===4){return true};
