...
// Write a function that takes two Date Objects as arguments and returns true if both daGlobal Variables
// tes occur on the same day of the week (both on Tuesdays, etc.), false otherwise
...
dates.isTheFuture = function(dateObj) {
  ...
  var difference  = dateObj - currentDate;
  return difference > 0;
};
...
dates.incrementDay = function(dateObj) {
  // YOUR CODE HERE
  var newDateString = dateObj.setDate(dateObj.getDate() + 1);
  var newDate = dates.createDate(newDateString);
  return newDate;
};
