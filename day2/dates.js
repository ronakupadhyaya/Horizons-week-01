...
dates.getUTCString = function(dateObj) {
  var dateObj = new Date (dateObj); //We need date object from date string, hence this step
  var UTCstring = dateObj.toUTCString(); //Converts date object into UTC string
  return UTCstring;
};
