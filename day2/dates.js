...
dates.isSameDayOfWeek = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  var dayOfWeekOne = dateObj.getDay();
  var dayOfWeekTwo = otherDateObj.getDay();
  return dayOfWeekOne === dayOfWeekTwo ? true : false;
};
...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  var hourDateOne = dateObj.getHours();
  var hourDateTwo = otherDateObj.getHours();
  console.log(hourDateOne);
  console.log(hourDateTwo);
  return hourDateTwo === hourDateOne ? true : false;
};
...
dates.isTheFuture = function(dateObj) {
  ...
  var objectDate = dateObj.getFullYear()+'-'+(dateObj.getMonth()+1)+'-'+ dateObj.getDate();
  if(objectDate > todaysDate){
    return true
  }
  return false
