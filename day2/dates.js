...
dates.isSameDayOfWeek = function(dateObj, otherDateObj) {
  var today = new Date(dateObj);
  var other = new Date(otherDateObj);
  return today.getDay() === other.getDay() ? true : false;
};
...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  var today = new Date(dateObj);
  var other = new Date(otherDateObj);
  return today.getHours() === other.getHours() ? true : false;
};
...
dates.isTheFuture = function(dateObj) {
  var today = Date.now();
  var testDate = new Date (dateObj);
  return testDate.getTime() > today ? true : false;
