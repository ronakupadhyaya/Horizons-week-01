...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  var sameHour = (dateObj.getHours() === otherDateObj.getHours());
  var sameMinute = (dateObj.getMinutes() === otherDateObj.getMinutes());
...
dates.incrementDay = function(dateObj) {
  ...
  console.log(dateObj);
  var strDateObj = dateObj.toString();
  var newDay = new Date(strDateObj); //copy of dateObj
  newDay.setDate(currentDay + 1);
  console.log(newDay);
  return newDay;
};
