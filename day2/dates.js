...
dates.createDate = function(dateStr) {
  // YOUR CODE HERE
var x= new Date(dateStr); // Date might be a special case?
return x
...
dates.isSameDayOfWeek = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  return dateObj.getDay() === otherDateObj.getDay() ? true:false;
};
...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  return dateObj.getHours() === otherDateObj.getHours() ? true:false;
};
...
dates.isTheFuture = function(dateObj) {
  ...
  var future1 = future.getTime();
  return future1>now ? true: false;
};
...
dates.incrementDay = function(dateObj) {
  // YOUR CODE
 dateObj.setDate(dateObj.getDate()+1) // getDate +1
return dateObj

// Why cant I declare a variable d and return it?
