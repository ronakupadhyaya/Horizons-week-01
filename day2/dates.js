...
dates.isSameDayOfWeek = function(dateObj, otherDateObj) {
  ...
  var secondDay = otherDateObj.getDay();
...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  var firstHour = dateObj.getHours();
  var firstMinute = dateObj.getMinutes();
  var secondHour = otherDateObj.getHours();
  var secondMinute = otherDateObj.getMinutes();
