...
dates.isSameTimeOfDay = function(dateObj, otherDateObj) {
  // YOUR CODE HERE
  return ((dateObj.getHours() === otherDateObj.getHours()) && (dateObj.getMinutes() === otherDateObj.getMinutes()) && (dateObj.getSeconds() === dateObj.getSeconds()));
};
...
dates.incrementDay = function(dateObj) {
  // YOUR CODE HERE
  return new Date(dateObj.getTime() + 8.64e7); // 8.64e7 is the amount of ms in a day
};
