...
//   lettersArray.push(array.split(''));
// });
//
// console.log(lettersArray);
//debugger;
//var newArray = [];
var objectOfArrays = _.groupBy(array, fun);

console.log(objectOfArrays);

 var newArray = _.mapObject(objectOfArrays, function(value, key) {
  return value.length;
});
