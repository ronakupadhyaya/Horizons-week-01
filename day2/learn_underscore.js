...
learn_underscore.contains = function(array, item) {
  return _.any(array, function(temp) {
    return temp === item;
  });
};
...
learn_underscore.any = function(array, fun) {
  var copy_map = _.map(array, fun);
  var reduced_map = _.reduce(copy_map, function(acc, compartor) {
    return acc || compartor
  });
  return reduced_map
}
...
learn_underscore.countBy = function(array, fun) {
  var temp = _.groupBy(array, function(x) {
    return fun(x);
  });
