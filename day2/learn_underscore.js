...
learn_underscore.keys = function(object) {
  // YOUR CODE HERE
  var arr=[];
  _.forEach(object, function(e, key){
     arr.push(key);
  })
  return arr;
...
learn_underscore.countLetters = function(string) {
  ...
  //identity is useful for clarity using compose() and mathematical operations
}
...
learn_underscore.countBy = function(array, fun) {
  ...
  console.log(obj);
  console.assert( _.mapObject(obj, function(arr, key){
    return arr.length;
  })
