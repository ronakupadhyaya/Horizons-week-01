...
learn_underscore.contains = function(array, item) {
  // YOUR CODE HERE
  return _.any(array, function(newItem) {
    return item === newItem;
  });
};
...
function newTruthy(a,b) {
  return a || b;
}
return _.reduce(_.map(array, fun), newTruthy);
}
...
//   return _.groupBy(array, fun(wordObject) {
//     return wordObject.key;
//
// var newObject = {};
// for (var i=0; i<array.length; i++) {
