...
learn_underscore.keys = function(object) {
  // YOUR CODE HERE
  var result = [];
  _.forEach(object, function(value, key) { result.push(key)});
  return result;
}
...
learn_underscore.countBy = function(array, fun) {
  // YOUR CODE HERE
  var arr = _.mapObject(array, fun);
  return _.countBy(arr, _.identity);
}
