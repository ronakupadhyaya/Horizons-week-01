...
learn_underscore.any = function(array, fun) {
  ...
  function isTrue(a, b) {
    ...
    return _.reduce(_.map(array,fun), isTrue);
}
...
learn_underscore.reduce = function(array, fun) {
  ...
  for (var i = 0; i < array.length-1; i ++){
    accumulator = fun(accumulator, array[i+1]);
  }
  return accumulator;
}
...
learn_underscore.keys = function(object) {
  // YOUR CODE HERE
  var returnArray = [];
  _.forEach(object, function(value, key){returnArray.push(key)});
  return returnArray;
}
...
learn_underscore.values = function(object) {
  // YOUR CODE HERE
  var returnArray = [];
  _.forEach(object, function(value, key){returnArray.push(value)});
  return returnArray;
}
...
learn_underscore.pairs = function(object) {
  // YOUR CODE HERE
  var returnArray = [];
  _.forEach(object, function(value, key){returnArray.push([key,value])});
  return returnArray;
}
...
learn_underscore.countBy = function(array, fun) {
  ...
  return _.mapObject(newObj, function(val,key){return val.length})
  ;
}
