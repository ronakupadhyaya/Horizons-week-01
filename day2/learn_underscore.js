...
learn_underscore.any = function(array, fun) {
  ...
  var value = _.reduce(newArray, function(accumulator, current){
...
// STEP ONE: return T/F for each item in array in response to function
...
// search object with _.forEach
// return new array
var newArray = []
   _.forEach(Object.keys(object),function(ana){
    newArray.push(ana)
  })
  return newArray
}
...
learn_underscore.values = function(object) {
  var newArray = []
  _.forEach(Object.values(object), function(value){
    newArray.push(value)
  })
  return newArray
}
...
learn_underscore.pairs = function(object) {
  var newArray = []
  _.forEach(Object.entries(object), function(both){
    newArray.push(both)
  })
