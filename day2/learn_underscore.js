...
learn_underscore.any = function(array, fun) {
  // YOUR CODE HERE
  var arrayOne = array.map(fun)
  var trueOrFalse = _.reduce(arrayOne, function(a, b){
    if(a || b){
      return true
    }
    return false
...
learn_underscore.reduce = function(array, fun) {
  var origComp = array[0];
  for(var i = 1; i < array.length; i++){
    origComp = fun(origComp, array[i])
  }
  return origComp
  // YOUR CODE HERE
}
