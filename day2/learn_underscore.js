...
var tempMap = _.map(array, fun)
var reduction = _.reduce(tempMap, function(a, b) {
  return (a || b)
})
return reduction;
}
...
_.forEach(object, function(item, key) {
  ...
  // var object1 = _.forEach(function(key) {
  //   return key;
  // });
  // return object1;
  // YOUR CODE HERE
...
learn_underscore.countBy = function(array, fun) {
  var temp1 = _.groupBy(array, fun);
  var temp2 = _.mapObject(temp1, function(val) {
    return val.length;
  });

  return temp2;
  //
  // var temp2 = _.map(temp1, _.identity);
  //
