...
learn_underscore.contains = function(array, item) {
  // YOUR CODE HERE
  return _.any(array, function(cur) {
    return cur === item;
  })
};
...
learn_underscore.any = function(array, fun) {
  ...
  return _.reduce(mapped, function(a, b)  {
    return a || b
  });
}
...
learn_underscore.reduce = function(array, fun) {
  // YOUR CODE HERE
  var accumulator = array[0];
  for (var i = 1; i < array.length; i++) accumulator = fun(accumulator, array[i]);
  return accumulator;
}
...
learn_underscore.keys = function(object) {
  // YOUR CODE HERE
  var result = [];
  result = _.forEach(Object.keys(object), function(item) {} )
  return result;
}
...
learn_underscore.values = function(object) {
  // YOUR CODE HERE
  var result = [];
  result = _.forEach(Object.values(object), function(item) {} )
  return result;
}
...
learn_underscore.pairs = function(object) {
  ...
  // }
  var x = _.forEach(Object.keys(object), function(key) {
    result.push([key, object[String(key)]]);
  })
  return result;
}
...
learn_underscore.countBy = function(array, fun) {
  ...
  debugger;
  var result = [];
  var groups = _.groupBy(array, fun);
  result = _.mapObject(groups, function(val, key) {
    return val.length;
  });
  return result;
}
