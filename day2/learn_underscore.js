...
learn_underscore.any = function(array, fun) {
  var arr1 =  _.map(array, function(n){
    return !! fun(n) })


  return _.reduce(arr1, function(a,b){
    return a || b;
  }, 0)
}
...
learn_underscore.countBy = function(array, fun) {
  var arr = _.groupBy(array, function(value, key){
    return fun(value, key);

  })
  var temp = _.mapObject(arr, function(val, key){
    return val.length
  })
  //return temp;
}
