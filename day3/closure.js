...
var once = function(f) {
  ...
  return function() {
    if (! called) { // if f hasn't been called yet
      ...
      // }
      // else {
      //   save2 = f(arguments[0], arguments[arguments.length-1])
      //   return f(arguments[0], arguments[arguments.length-1]);
      // }
      //what are the arguments
      //returned NaN bc the argument is squareNum
    }
   else {
       return save2;
     }
