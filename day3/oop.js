...
//    this.name = name;
//    // When the object is instantiated, this statement assigns a given argume
//nt `name` to the `name` property in an instance of the Person object.
//    ...
//  };
...
//
// hint. see http://stackoverflow.com/questions/387707/what-techniques-can-be-us
//ed-to-define-a-class-in-javascript-and-what-are-their
...
Student.prototype.getGPA = function(){
  var total = 0;
  total = this.grades.reduce(function(a,b){
    return a+b;
  });
...
// Write a function that takes an array of the <Student> objects you've imple
//mented and return an array of the students sorted from lowest to highest.
//
//
// ex.
