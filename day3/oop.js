...
// Write a function that takes an array of the <Student> objects you've implemented
//and return an array of the students sorted from lowest to highest.
//
//
// ex.
...
var sortByGPA = function(students) {
  // YOUR CODE HERE
  debugger;
  Student(students[0], students[1], students[2]);
