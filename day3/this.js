...
dis.assignGetThis = function() {
  ...
  return dis.object2.getThis() === window.dis.object2; /* YOUR CODE HERE */;
};

dis.callGetThis = function() {
  return dis.getThis.call(dis.object1) === window.dis.object1; /* YOUR CODE HERE */;
}
...
dis.callBoundGetThis = function() {
  return dis.boundGetThis.call(dis.object1) === window.dis.object2; /* YOUR CODE HERE */;
}
