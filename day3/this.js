...
dis.assignGetThis = function() {
  ...
  return dis.object2.getThis() === window.dis.object2;
};

dis.callGetThis = function() {
  return dis.getThis.call(dis.object1) === window.dis.object1;
}
...
dis.callBoundGetThis = function() {
  return dis.boundGetThis.call(dis.object1) === window.dis.object2;
}
