...
dis.simpleGetThis = function() {
  return dis.getThis() === dis|| null /* YOUR CODE HERE */;
};

dis.assignGetThis = function() {
  dis.object2.getThis = getThis;
  return dis.object2.getThis() === dis.object2 || null/* YOUR CODE HERE */;
};

dis.callGetThis = function() {
  return dis.getThis.call(dis.object1) === dis.object1||null /* YOUR CODE HERE */;
}
...
dis.callBoundGetThis = function() {
  return dis.boundGetThis.call(dis.object1) === dis.object2|| null /* YOUR CODE HERE */;
}
