...
function memoize(func) {
  var resLst = {};
  return function () {
    if (!(arguments[0] in resLst)) {
      resLst[arguments[0]] = func(arguments[0]);
      console.log("called");
    }
    return resLst[arguments[0]];
  }
}
...
function partial(fn) {
  ...
  var saveArgs = Array.prototype.slice.call(arguments, 1);
  return function () {
    var newArgs = saveArgs.concat(Array.prototype.slice.call(arguments));
...
function composeBasic(fun1, fun2) {
  return function () {
    return fun1(fun2.apply(this,Array.prototype.slice.call(arguments)));
  }
}
