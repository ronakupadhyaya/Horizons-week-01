...
EventEmitter.prototype.emit = function(eventName, arg) {
  let listenerFunctions = this.listeners[eventName];

  if (listenerFunctions && listenerFunctions.length) {
    listenerFunctions.forEach(function (listenerFunction) {
      listenerFunction(arg);
    });
  }
...
EventEmitter.prototype.once = function(eventName, fn) {
  ...
  function checkIfCalled() {
    self.removeListener(eventName, checkIfCalled);
  ...
  checkIfCalled.listener = fn;
  this.on(eventName, checkIfCalled);
  return this;
}
