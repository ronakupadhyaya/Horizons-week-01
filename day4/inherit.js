...
// You've learned how to create a class, define its properties and methods, and now you're going to learn
// how to build on top of your own classes to augment and add functionality.
...
// note. "Inheritance" will allow the `Student` class to get all the properties and methods defined on the `Person`
// class while also allowing you to overload them.  This allows you to re-use code implemented elsewhere and provides
// a good way to  separate your logic.
//
// hint. the syntax for defining a class that inherits from another (sometimes called a *sub-class* or *child-class*)
// is as such:
//
...
//
// Even though getColor was not defined in the `Banana` class, it was defined on the `Fruit` class, which `Banana`
// inherits from, which it can then use.
