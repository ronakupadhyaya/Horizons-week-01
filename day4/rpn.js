...
window.rpnCalculator = function(rpnString) {
  var splitRpnString = rpnString.split(' ');
  //console.log(splitRpnString)
  //console.log(splitRpnString)
  var stack = [];
  for(var i = 0; i < splitRpnString.length; i++){
    if(! isNaN(parseInt(splitRpnString[i]))){
      stack.push(splitRpnString[i]);
      console.log('run ' + i)
console.log(stack)
    }else{
